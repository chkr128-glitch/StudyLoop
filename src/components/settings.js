    ...
    container.innerHTML = `
        ...
        <div class="mb-4 bg-gray-50 dark:bg-gray-700/30 p-4 rounded-2xl border border-gray-100 dark:border-gray-700">
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-[10px] font-bold text-pink-500">目標得点:</span>
        ...
        <div class="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-2xl border border-gray-100 dark:border-gray-700">
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-[10px] font-bold text-purple-500">目標得点:</span>
...
export function renderSettings(routines, userProfile) {
    ...
    if (userProfile.examScores) {
        ...
        ['国語', '数学IA', '数学IIBC', '英語R', '英語L', '情報', 'targetScore'].forEach(s => { const el = document.getElementById(s === 'targetScore' ? 'c-target-score' : `c-${s}`); if(el) el.value = cs[s] || ''; });
        ...
        ['国語', '数学', '英語', 'targetScore'].forEach(s => { const el = document.getElementById(s === 'targetScore' ? 's-target-score' : `s-${s}`); if(el) el.value = ss[s] || ''; });
